...
export function MidPageCTA() {
  return (
    <section className="relative border-y border-gold/20 bg-gold-pale/50 px-4 py-14 sm:px-6 sm:py-16">
      <motion.div
      ...
      >
        ...
        <button onClick={() => scrollToSection("contact")} className="btn btn-gold btn-arrow shrink-0">
          Get My Quote
        </button>
      </motion.div>
    </section>
