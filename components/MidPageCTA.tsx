    ...
    <section className="bg-gold-pale/40 px-4 py-14 sm:px-6">
      ...
      >
        ...
        <button
          ...
          className="shrink-0 cursor-pointer rounded-sm bg-gold px-7 py-3.5 font-body text-[0.88rem] font-semibold text-white transition-all hover:bg-gold-dark hover:shadow-lg"
        >
          Speak To Our Team
        </button>
      </motion.div>
