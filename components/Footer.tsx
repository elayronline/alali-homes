    ...
    <footer className="border-t border-grey-200 bg-charcoal px-4 pt-16 pb-8 sm:px-6">
      <div className="mx-auto max-w-6xl">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-5 flex gap-3">
              <a
                ...
                className="flex h-9 w-9 items-center justify-center rounded-full border border-white/10 text-white/40 transition-all hover:border-gold/40 hover:text-gold"
          ...
          {/* Col 3: Services — now clickable (#9) */}
          <div>
            <h4 className="font-body text-[0.72rem] font-semibold uppercase tracking-[0.15em] text-gold">
              Services
            </h4>
